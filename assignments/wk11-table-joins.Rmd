...
For this assignment, you're going to re-create this .html file and get to use some of the data joining functions from the `dplyr` package. 
...
+ Copy and paste the necessary sections from the [exercises](https://mjfrigaard.github.io/FA22-JOUR301/exercises/table-joins.html) to get the **Example** and **Solution** to work
